CREATE TABLE [234182].[Customer] (
    ...
    [ValidFrom]    DATETIME2 (7) GENERATED ALWAYS AS ROW START HIDDEN DEFAULT (getutcdate()) NOT NULL,
...
WITH (SYSTEM_VERSIONING = ON (HISTORY_TABLE=[234182].[CustomerHistory], DATA_CONSISTENCY_CHECK=ON));
